<template>
  <main>
    <div id="image" >
     <img src= "../assets/pexels-li-sun-2294403.jpg" class="img-fluid" alt="...">
      </div>
...
import monFooter from "./Footer.vue";
export default {
  name :"mesCards",
     ...
     data(){
       return{
         ...
         verf:true
           ...
           methods:{
             onScroll() {
      this.home = (window.innerHeight +window.scrollY)/(document.body.offsetHeight);
      // console.log({ y:this.home });
    }
